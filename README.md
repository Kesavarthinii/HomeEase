...
3. Configure **MySQL Extension** and create database:
...
5. Deploy project on **Apache Tomcat 9** and access at:
...
1. User searches properties → `SearchServlet.java`
2. Chooses a property → fills booking form (modal in JSP)
3. Form submits to `BookingServlet.java`
4. Booking stored in `bookings` table
5. Redirects to `bookingConfirmation.jsp`
